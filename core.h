...
// Last modified: 2025-08-10T22:57:50+0200
...
// Convert a stiffness matrix to Abaqus format and SI units.
extern void toabaqusi(double src[6][6], double dest[6][6]);
extern bool isortho(double src[6][6]);
