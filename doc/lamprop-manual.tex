...
% Last modified: 2026-02-19T22:18:10+0100
...
A \texttt{c:} line describes a comment. The comment should appear before an
...
The program has the following storage limits:
\begin{itemize}
  \item 1000 resins
  \item 1000 fibers
  \item 25000 lamina
...
By using the \texttt{-i} option, you can see how many of that space has been
used.
...
\begin{table}[!ht]
  ...
  \tiny generated by lamprop-c version 2026.02.19\\[3pt]}
...
Calculate the elastic properties of a fibrous composite laminate. See the
manual (lamprop-manual.pdf) for more in-depth information.
