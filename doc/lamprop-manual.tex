...
% Last modified: 2026-02-01T19:50:52+0100
...
Right-click in that folder, and select “Open in Terminal”.
%, see \frefpi{fig:open-in-terminal1}.

%\begin{figure}[!h]
%  \centerline{\includegraphics[scale=0.451]%
%    {fotos/lamprop/open-in-terminal1}}
%  \caption{\label{fig:open-in-terminal1}Open a terminal}
%\end{figure}
